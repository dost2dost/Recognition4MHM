 ...
 */
public class MyFaceDetector  extends JFrame implements Runnable, WebcamPanel.Painter {
    ...
    public MyFaceDetector() throws IOException {
    ...
    public void paintImage(WebcamPanel panel, BufferedImage image, Graphics2D g2) {
       ...
       // FImage bfg = face.getFacePatch();
           String name= CompareImage.compar(image);
